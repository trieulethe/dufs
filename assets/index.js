...
const ICONS = {
  ...
  iframe: `<svg width="16" height="16" viewBox="0 0 16 16">
    ...
    $pathsTableBody.insertAdjacentHTML(
      ...
      <tr id="addPath${index}">
        ...
        <td class="cell-iframe">
          <code id="htmlCode">&lt;iframe src="${url.replace(location.origin, "https://stream.pornhubxx.com/html")}index.html" height="480" width="854"/&gt;</code>
        </td>
      </tr>`
    );
  } else {
